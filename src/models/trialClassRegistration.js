...
const TrialClassRegistration = sequelize.define(
    'TrialClassRegistration',
    {
        ...
        ai_informed: {
            ...
            allowNull: false,
            defaultValue: false,
            comment: '0 = not informed, 1 = AI has informed the student'
        },
        ai_informed_at: {
            type: DataTypes.DATE,
            allowNull: true,
            defaultValue: null,
            comment: 'Timestamp when AI informed the student'
        },
        ai_call_result: {
            type: DataTypes.STRING(255),
            allowNull: true,
            defaultValue: null,
            comment: 'Result of the AI call to the student (e.g. informed, no_answer, voicemail, wrong_number)'
        },
        created_at: {
            type: DataTypes.DATE,
            allowNull: false,

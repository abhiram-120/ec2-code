...
const FamilyPastDuePayment = require('./FamilyPastDuePayment');
const FamilyDunningSchedule = require('./FamilyDunningSchedule');
...
const LlmResponse = require('./llmResponse');
const LlmRequest = require('./llmRequest');
const LlmIntakeQueue = require('./llmIntakeQueue');
const LlmAudioAnalysis = require('./llmAudioAnalysis');
...
const setupAssociations = () => {
    ...
    // Admin who processed a refund on this payment transaction
    PaymentTransaction.belongsTo(User, {
    ...
    User.hasMany(PaymentTransaction, {
        foreignKey: 'refund_processed_by',
        sourceKey: 'id',
        as: 'RefundProcessedTransactions'
    });
    ...
    FamilyPaymentTransaction.belongsTo(User, {
        foreignKey: 'refund_processed_by',
        targetKey: 'id',
        as: 'RefundProcessor',
        onDelete: 'SET NULL'
    ...
    // FamilyPastDuePayment associations
    FamilyPastDuePayment.belongsTo(Family, {
        foreignKey: 'family_id',
        targetKey: 'id',
        as: 'Family'
    });

    FamilyPastDuePayment.belongsTo(FamilyPaymentTransaction, {
        foreignKey: 'family_payment_transaction_id',
        targetKey: 'id',
        as: 'FamilyPaymentTransaction'
    });

    Family.hasMany(FamilyPastDuePayment, {
        foreignKey: 'family_id',
        sourceKey: 'id',
        as: 'PastDuePayments'
    });

    FamilyPaymentTransaction.hasMany(FamilyPastDuePayment, {
        foreignKey: 'family_payment_transaction_id',
        sourceKey: 'id',
        as: 'PastDuePayments'
    });

    // FamilyDunningSchedule associations
    FamilyDunningSchedule.belongsTo(FamilyPastDuePayment, {
        foreignKey: 'family_past_due_payment_id',
        targetKey: 'id',
        as: 'FamilyPastDuePayment'
    });

    FamilyDunningSchedule.belongsTo(Family, {
        foreignKey: 'family_id',
        targetKey: 'id',
        as: 'Family'
    });

    FamilyPastDuePayment.hasOne(FamilyDunningSchedule, {
        foreignKey: 'family_past_due_payment_id',
        sourceKey: 'id',
        as: 'DunningSchedule'
    });

    Family.hasMany(FamilyDunningSchedule, {
        foreignKey: 'family_id',
        sourceKey: 'id',
        as: 'DunningSchedules'
    });
    ...
    LlmResponse.belongsTo(LlmRequest, {
        foreignKey: 'request_id',
        targetKey: 'id',
        as: 'request'
    });
    ...
    // =====================================
    // llm_requests ↔ llm_audio_analyses
    // =====================================

    // One request → one audio analysis
    LlmRequest.hasOne(LlmAudioAnalysis, {
        foreignKey: 'job_id',
        sourceKey: 'id',
        as: 'audioAnalysis',
        onDelete: 'CASCADE',
    ...
    LlmAudioAnalysis.belongsTo(LlmRequest, {
        foreignKey: 'job_id',
        targetKey: 'id',
        as: 'request'
    });
    ...
    // =====================================
    // llm_requests ↔ llm_intake_queue
    // =====================================

    // One request ← one intake item (after admitted)
    LlmRequest.hasOne(LlmIntakeQueue, {
        foreignKey: 'request_id',
        sourceKey: 'id',
        as: 'intakeItem'
    });

    LlmIntakeQueue.belongsTo(LlmRequest, {
        foreignKey: 'request_id',
        targetKey: 'id',
        as: 'request'
    });

    ...
    try {
        ...
        for (const student of students) {
            ...
            await sequelize.transaction(async (transaction) => {
                ...
                const noScheduleEvents = await checkNoScheduleThisMonth(studentId, startOfPrevMonth, endOfPrevMonth, transaction);
                ...
                const monthEvents = [
                    ...
                    ...noScheduleEvents.map((ev) => ({ ...ev, event_key: `${ev.event_key}_${monthKey}` })),

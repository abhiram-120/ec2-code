...
const config = {
    ...
    // database connection information
    host: envVars.MYSQL_HOST || envVars.HOST,
    dbPort: envVars.MYSQL_PORT || 3306,
    user: envVars.MYSQL_USER || envVars.USER,
    password: envVars.MYSQL_PASSWORD || envVars.PASSWORD,
    database: envVars.MYSQL_DATABASE || envVars.DATABASE,

...
const updateTrialClass = async (req, res) => {
    ...
    try {
        ...
        const oldTrialClassValue = createActionLogSnapshot(trialClass.get({ plain: true }));
        ...
        await ActionLog.create(
            {
                ...
                action_type: 'update trial class',
                target_entity: 'class',
                target_id: parseInt(id),
                old_value: oldTrialClassValue,
                new_value: createActionLogSnapshot(trialClass.get({ plain: true })),
                created_at: new Date()
            },
            { transaction }
        );
...
const cancelTrialClass = async (req, res) => {
    ...
    try {
        ...
        await ActionLog.create(
            {
                actor_id: req.user.id,
                action_type: 'cancel trial class',
                target_entity: 'class',
                target_id: parseInt(id),
                old_value: oldTrialClassValue,
                new_value: createActionLogSnapshot(trialClass.get({ plain: true })),

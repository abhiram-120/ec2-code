    ...
    static notificationTemplates = {
        ...
        Notification_settings_updated_success: {
            EN: {
                ...
                content: 'Your notification settings have been saved.'
            },
            HE: {
                title: 'הגדרות ההתראות עודכנו בהצלחה!',
                content: 'הגדרות ההתראות שלך נשמרו.'
            }
        },
        ...
        family_payment_confirmation: {
            EN: {
                title: 'Family Payment Successful - Welcome to Tulkka!',
                content: "Family Payment Successful - Welcome to Tulkka!\n\nDear {{parent_name}} 👋🏼,\n\nThank you for completing the payment for your family.\n\n👨‍👩‍👧‍👦 Children Registered ({{children_count}}): {{children_names}}\n💲 Amount Paid: {{total_amount}} {{currency}}\n📄 Transaction ID: {{transaction_id}}\n🧾 Payment Type: {{payment_type}}\n📅 Payment Date: {{confirmation_date}}\n\nYour parent account and all kids' accounts have been created with the default password: 12345678.\nFor security, we recommend changing the password after first login.\n\nYour children can now start or continue their learning journey with Tulkka.\n\nIf you have any questions, our support team is here to help at {{support_email}}.\n\nWith love,\nTulkka Team 📚"
            },
            HE: {
                title: 'תשלום משפחתי בוצע בהצלחה - ברוכים הבאים לטולקה!',
                content: "תשלום משפחתי בוצע בהצלחה - ברוכים הבאים לטולקה!\n\nשלום {{parent_name}} 👋🏼,\n\nתודה רבה על השלמת התשלום עבור המשפחה.\n\n👨‍👩‍👧‍👦 ילדים שנרשמו ({{children_count}}): {{children_names}}\n💲 סכום ששולם: {{total_amount}} {{currency}}\n📄 מזהה עסקה: {{transaction_id}}\n🧾 סוג תשלום: {{payment_type}}\n📅 תאריך תשלום: {{confirmation_date}}\n\nלחשבון ההורה ולחשבונות כל הילדים הוגדר סיסמה ראשונית זהה: 12345678.\nמטעמי אבטחה, מומלץ לשנות את הסיסמה לאחר ההתחברות הראשונה.\n\nכעת הילדים יכולים להתחיל או להמשיך את מסע הלמידה שלהם עם Tulkka.\n\nאם יש לך שאלות, צוות התמיכה שלנו זמין בכתובת {{support_email}}.\n\nבאהבה,\nצוות Tulkka 📚"
            }
        },
        family_payment_refund_notification: {
            EN: {
                title: 'Family Payment Refund Processed - Tulkka',
                content: "Hello {{family.name}},\n\nYour family payment refund has been processed successfully.\n\n👨‍👩‍👧‍👦 Children count: {{children.count}}\n\n💰 Refund Details:\n• Type: {{refund.type}}\n• Amount: {{amount}} {{currency}}\n• Original Family Payment: {{original.amount}} {{currency}}\n• Transaction ID: {{transaction.id}}\n• Date: {{refund.date}}\n\n📋 Reason: {{refund.reason}}\n\nThe refund will appear on your original payment method within 3-7 business days.\n\nIf you have any questions regarding this refund, please contact our support team at {{support.email}}.\n\nBest regards,\nThe Tulkka Team"
            },
            HE: {
                title: 'זיכוי תשלום משפחתי עובד - טולקה',
                content: "שלום {{family.name}},\n\nהזיכוי עבור התשלום המשפחתי שלך עובד בהצלחה.\n\n👨‍👩‍👧‍👦 מספר ילדים: {{children.count}}\n\n💰 פרטי הזיכוי:\n• סוג: {{refund.type}}\n• סכום: {{amount}} {{currency}}\n• תשלום משפחתי מקורי: {{original.amount}} {{currency}}\n• מזהה עסקה: {{transaction.id}}\n• תאריך: {{refund.date}}\n\n📋 סיבה: {{refund.reason}}\n\nהזיכוי יופיע באמצעי התשלום המקורי תוך 3–7 ימי עסקים.\n\nאם יש לך שאלות לגבי זיכוי זה, אנא פנה לצוות התמיכה שלנו ב-{{support.email}}.\n\nבברכה,\nצוות טולקה"
            }
        },
        payment_recovery: {
            EN: {

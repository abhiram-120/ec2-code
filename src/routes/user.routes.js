...
router.put('/change-password', AuthValidator, userController.changeUserPassword);
router.get('/home-screen-details',AuthValidator,userController.homeScreenDetails);
...
router.get('/view-classes/:classId', AuthValidator, userController.viewClassDetails);
...
router.get('/ai-feedbacks', AuthValidator, userController.aiFeedback);
...
// Audio broadcast listen tracking
// router.post('/audio-broadcasts/:id/listen/start', AuthValidator, userController.startAudioBroadcastListen);
// router.post('/audio-broadcasts/:id/listen/progress', AuthValidator, userController.updateAudioBroadcastListenProgress);
// router.post('/audio-broadcasts/:id/listen/complete', AuthValidator, userController.completeAudioBroadcastListen);
